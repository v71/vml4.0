	...
	class CleoCopter  : public vml::objects::Object3d_2
	{
		...
		private:
			...
			void LandingGearControl()
			{
				...
				if (LandingGearState == 2)
				{
					if (LandingGearModel->GetPosY() < LandingGearMaxY)
				...
				if (LandingGearState == 3)
				{
					if (LandingGearModel->GetPosY() > LandingGearMinY)
						LandingGearModel->MoveY(-LandingGearSpeed);
		...
		public:
			...
			*/
			...
			void CreateObject(const std::string& sourcepath, const glm::vec3 &pos, const glm::vec3& rot, const glm::vec3& scaling,bool landinggearup=true)
			{
				...
				int rotmode = vml::models::Model3d_2::EULER;
				...
				LandingGearMinY = LandingGearModel->GetPosY();
			...
			CleoCopter(vml::geo2d::PathFinder* pathfinder, const std::string& sourcepath,const std::string& screenname, vml::handlers::Scene* scene, const glm::vec3& pos, const glm::vec3& rot, const glm::vec3& scaling) : vml::objects::Object3d_2(screenname)
			{
				BodyModel        = nullptr;
				CanopyModel      = nullptr;
				JetsModel        = nullptr;
