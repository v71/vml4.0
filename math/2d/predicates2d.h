...
namespace vml
{
	namespace geo2d
	{
		...
		struct Triangle
		{
			vml::math::vec2f P0;	// first vertex
			vml::math::vec2f P1;	// second vertex
			vml::math::vec2f P2;	// third vertex
			...
			Triangle(const vml::math::vec2f& p0, const vml::math::vec2f& p1, const vml::math::vec2f& p2) :P0(p0), P1(p1),P2(p2)
			{
			}

			Triangle(const float p0x, const float p0y, const float p1x, const float p1y, const float p2x, const float p2y) : P0(p0x,p0y), P1(p1x,p1y),P2(p2x,p2y)
			{
			}
